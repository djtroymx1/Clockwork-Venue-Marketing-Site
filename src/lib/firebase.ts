...
const seedManual = async () => {
    ...
    if (versionsSnapshot.empty) {
        ...
        const pagesData = [
            { slug: 'getting-started', title: 'Getting Started', order: 1, bodyMarkdown: 'Welcome to Clockwork Venue! This manual will guide you through the essentials.\n\nFirst, set up your club profile and add your staff members.' },
            { slug: 'roles-and-permissions', title: 'Roles & Permissions', order: 2, bodyMarkdown: 'Clockwork Venue uses roles to control access.\n\n- **Manager**: Can see everything.\n- **DJ**: Can manage rotations.\n- **Floor**: View-only access.' },
